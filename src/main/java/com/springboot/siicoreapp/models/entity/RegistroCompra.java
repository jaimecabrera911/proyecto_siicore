...
public class RegistroCompra implements Serializable{
	...
	public Long getId_registro_compra() {
		return id_registro_compra;
	}
	public void setId_registro_compra(Long id_registro_compra) {
	...
	public String toString() {
		return "Compra [id_registro_compra=" + id_registro_compra + ", tipo_comprobante=" + tipo_comprobante
